...
namespace Framework {
	...
	public class NotificationCenter
	{
		...
		private Dictionary<string, OnNotificationDelegate> listeners = new Dictionary<string, OnNotificationDelegate> ();

		public void AddListener(string type, OnNotificationDelegate newListenerDelegate) {
		...
		public void RemoveListener(string type, OnNotificationDelegate listenerDelegate) {
	    ...
	    public void PostNotification(Notification note) {
			...
			if (listeners.ContainsKey (note.type)) {
				listeners [note.type] (note);
			}
	    }
		public void PostNotification(string type) { PostNotification(type, null); }
		public void PostNotification(string type, object data) { PostNotification(new Notification(type, data)); }
	}
